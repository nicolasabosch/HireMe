...
namespace EmmploymeNet.Library
{

    public class ToolsLib
    {

        public static void SendEMail(string receiverMail, string subject, string body)
        {
            SendEMail(new[] { receiverMail }, null, subject, body);
        }
        public static void SendEMail(string[] receiverMailList, string[] bccMailList,  string subject, string body)
        {
        ...
        public static System.Data.DataTable ConvertToDataTable(IQueryable queryResult)
        {
        ...
        public static bool VerifyPasword(string userID, string hashedPassword, string clearPassword)
        {
            try
            {
        ...
        public static string hashPasword(string userID, string clearPassword)
        {
